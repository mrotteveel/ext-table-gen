...
We will only fix issues reported and reproducible against Java versions which are in support according to the OpenJDK project.
At the time of writing this -- May 2026 -- that means Java 21, Java 25, and Java 26.
