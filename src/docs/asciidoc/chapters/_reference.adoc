...
The `integer` elements represents the Firebird datatype `INTEGER`.
...
The `int128` elements represents the Firebird datatype `INT128`.
...
The `smallint` elements represents the Firebird datatype `SMALLINT`.
