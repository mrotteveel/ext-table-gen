// SPDX-FileCopyrightText: Copyright 2023-2024-2026 Mark Rotteveel
...
/**
 * A datatype representing the Firebird datatype {@code NUMERIC}.
 *
 * @since 2
 */
public final class FbNumeric extends AbstractFbFixedPointDatatype {
